...
if pagina == 'Modelo Custos':
    ...
    regiao = st.selectbox("Região em que mora", ['southeast', 'southwest', 'northeast', 'northwest'])
...
if pagina == 'Modelo Fumante':
    ...
    dados0 = {'age': [idade], 'sex': [sexo], 'bmi': [imc], 'children': [criancas], 'charges': [custos], 'region': [regiao]}
    dados = pd.DataFrame(dados0)
